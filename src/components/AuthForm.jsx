...
const AuthForm = ({status, onSubmit, handleGoogleLogin, handleLogin}) => {
        ...
        <div className="signin-signup">
          ...
          <img src={avatar} className='rounded-full w-32 border p-2 border-primary' />
            ...
            <div className="border-[1px] border-slate-400 flex items-center mx-3 md:mx-0 gap-2 bg-slate-50 px-2 my-1 md:my-3 rounded-lg">
              ...
              <input  className='p-2 bg-transparent focus:outline-none my-1 md:my-3' type="text" placeholder="Email" name='email' onChange={handleChange} />
            </div>
          ...
          <img src={avatar} className='rounded-full w-32 border p-2 border-primary' />
            ...
            <div className="social-media">
              <a href="#" className="social-icon"><FaFacebookF /></a>
              <button onClick={handleGoogleLogin} href="#" className="social-icon"><FaGoogle /></button >
              <a href="#" className="social-icon"><FaLinkedinIn /></a>
            </div>
          </div>
        </div>
